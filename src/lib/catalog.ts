...
export const sampleProducts: Product[] = [
  ...
  {
    id: "44444444-4444-4444-8444-444444444444", slug: "titun-discovery-gift-box", name: "TITUN Discovery Gift Box", scent: "Green tea, lemongrass and sandalwood", description: "A presentation-ready collection of TITUN refreshing towels, composed in any mix of signature fragrances.", category: "Boxes and multipacks", packSize: "Custom 25, 50 or 100-piece gift box", price: 5000000, currency: "NGN", stockOnHand: 9, stockReserved: 0, lowStockThreshold: 5, lowStockAlertedAt: null, images: ["/images/titun/gift-box.jpg"], featured: false, active: true, createdAt: now, updatedAt: now,
  },
  {
