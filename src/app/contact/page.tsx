...
export default function ContactPage() {
  return (
    <ContentPage title="Let’s talk about the moment." introduction="Questions about products, an order or a hospitality project? Choose the most direct way to reach TITUN.">
